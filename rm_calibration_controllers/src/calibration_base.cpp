...
{
template class CalibrationBase<hardware_interface::ActuatorExtraInterface, hardware_interface::EffortJointInterface>;
                                 ...
                                 ros::NodeHandle& controller_nh)
{
  ...
  actuator_ = robot_hw->get<hardware_interface::ActuatorExtraInterface>()->getHandle(actuator[0]);
